    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-400">
      ...
      {!isEmailSent && (
        ...
        >
          ...
          <button className="w-full py-2.5 active:scale-95 active:brightness-90 cursor-pointer bg-gradient-to-r from-indigo-500 to-indigo-900 text-white rounded-full mt-3">
            Submit
          </button>
        </form>
      )}
